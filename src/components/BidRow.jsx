...
const BidRow = ({ bid,handleStutasChange }) => {
    const { price,deadline,title,category,status,_id} = bid ||{} ;
  return (
            <tr>
                ...
                <td className='px-4 py-4 text-sm whitespace-nowrap'>
                    {/* mark has compleate */}
                    <button onClick={()=>handleStutasChange(_id,status,'Complated')}
                        title='Mark Complete'
                        disabled = {status !== 'Is progress'}
